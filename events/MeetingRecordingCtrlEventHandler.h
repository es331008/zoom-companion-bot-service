#ifndef MEETINGRECORDCTRLEVENT_H
#define MEETINGRECORDCTRLEVENT_H
...
class MeetingRecordingCtrlEventHandler : public IMeetingRecordingCtrlEvent {

    function<void(bool)> m_onRecordingPrivilegeChanged;

public:
    MeetingRecordingCtrlEventHandler(function<void(bool)> onPrivilegeChanged) : m_onRecordingPrivilegeChanged(onPrivilegeChanged) {};
    ~MeetingRecordingCtrlEventHandler() {};
...
#endif //MEETINGRECORDCTRLEVENT_H